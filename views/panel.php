...
<head>
  ...
  <!-- Documentación font Awsomw:  https://fontawesome.com/v5/search?m=free -->
   <script src="https://kit.fontawesome.com/77119b9ce1.js" crossorigin="anonymous"></script>
  <!-- Ionicons -->
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            <!-- Componente Caja -->
            <?php mostrarCaja('verde', '58', 'Ventas Enero', 'http://google.com','barras'); ?>
            <!-- Componente Caja -->
          </div>
          
          <div class="col-lg-3 col-6">
            <!-- Componente Caja -->
            <?php mostrarCaja('amarillo', '44', 'Usuarios Registrados', 'http://google.com','persona'); ?>
            <!-- Componente Caja -->
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            <!-- Componente Caja -->
            <?php mostrarCaja('rojo', '65', 'Visitas', 'http://google.com','pastel'); ?>
            <!-- Componente Caja -->
          </div>
